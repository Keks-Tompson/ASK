    ...
    public class ExcelReport_Services : IExcelReport
    {
        ...
        public MemoryStream GenerateDefaultReport(Report_Model report_day, DateTime authData)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                if (GlobalStaticSettingsASK.VisibilityReportOptions.Pressure != "none") AddColumn(ref worksheet, "Режим", "", excelReportDay.ReportDay.TableReport.Select(s => s.Mode_ASK).ToList(), excelReportDay.ReportDay.sumTotal_20M.Mode_ASK, true, false);
                if (GlobalStaticSettingsASK.VisibilityReportOptions.Pressure != "none") AddColumn(ref worksheet, "ПДК", "", excelReportDay.ReportDay.TableReport.Select(s => (double)s.PDZ_Fuel).ToList(), excelReportDay.ReportDay.avgTotal_20M.PDZ_Fuel, false, true);
