...
namespace ASK.Controllers.Setting
{
    public  class GlobalStaticSettingsASK
    {
        ...
        {
            StreamWriter file = File.CreateText("SensorRange_JSON");
        ...
        static GlobalStaticSettingsASK()
        {
            ...
            //                                                  SensorRangeJSON
            //-------------------------------------------------------------------------------------------------------------------------------------------
            if (File.Exists("SensorRange_JSON"))
            {
                string data = File.ReadAllText("SensorRange_JSON");
