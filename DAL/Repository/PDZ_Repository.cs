...
{
    public class PDZ_Repository : IPDZ
    {
        readonly ApplicationDbContext db;

        public PDZ_Repository(ApplicationDbContext _db)
        {
            db = _db;
        }
        ...
        {
            var dbPDZ = db.PDZ.ToList();
            var pdz = dbPDZ.FirstOrDefault(a => a.Date.Year == date.Year && a.Date.Month == date.Month && a.Current == true);
